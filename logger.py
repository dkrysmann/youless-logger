...
class YoulessBaseLogger:
    ...
    def youless_path(self) -> str:
        raise NotImplementedError('youless_path attribute needs to be implemented in deriving class')

    @property
    def table_name(self) -> str:
        raise NotImplementedError('table_name attribute needs to be implemented in deriving class')

    @property
    def granularity(self) -> str:
        raise NotImplementedError('granularity attribute needs to be implemented in deriving class')
    ...
    def table_exists(self) -> bool:
        ...
        with sql.connect(DB_PATH) as con:
            cur = con.cursor()
            listOfTables = cur.execute(query.format(table_name=self.table_name)).fetchall()
